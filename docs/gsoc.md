...
!!! info "About the program"
    [Google Summer of Code](https://summerofcode.withgoogle.com/) is an online program that supports junior software developers to contribute to open source software development.
...
[Read the full report](https://medium.com/@nassermohamed3222/my-google-summer-of-code-2024-journey-with-the-osipi-foundation-b4ad4d738e2d).
...
[Read the full report](https://github.com/Trico01/pyasl/wiki/PyASL_GSoC'24-Final-Report).
...
[Read the full report](https://gist.github.com/AhmedBasem20/76c37422dcbd7aab5922b96897188daf).
...
See the [news announcement](https://osipi.ismrm.org/gsoc-2025-5-projects-selected/) for details.
